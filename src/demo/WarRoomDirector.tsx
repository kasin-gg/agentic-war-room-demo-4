      ...
      <div className="flex items-center justify-between border-b border-cyan-500/20 pb-2">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-cyan-300 tracking-wider">
            DEMO DIRECTOR OVERLAY
          </span>
        </div>
        <div className="flex items-center gap-2">
          <span className="text-[10px] text-gray-400 bg-gray-800/80 px-2 py-0.5 rounded border border-gray-700">
            PHASE {director.phase} ({director.clock})
          </span>
          <button
            onClick={() => setIsCollapsed((p) => !p)}
            className="px-1.5 py-0.5 rounded bg-gray-800 hover:bg-gray-700 text-gray-300 hover:text-cyan-300 border border-gray-700 text-[10px]"
